...
function toggleMod() {
	...
	var bOpera = (navigator.userAgent.indexOf('Opera') != -1);
	var bMoz = (navigator.appName == 'Netscape');
	var passwordbox = document.getElementById("modbox");
	var passwordbox_html;
	...
	if (passwordbox_html == newhtml) {
		var newhtml = '<td align="right">[ <input name="deleteall" onclick="return confirm(\'Are you sure you want to delete this post/thread?\');" type="submit" value="D"/> &amp; <input name="banquickuser" type="submit" value="B"/> ]</td>';
	}
...
function expandimg(I, H, F, C, G, E, A) {
    element = document.getElementById("thumb" + I);
    var D = '<img src="' + F + '" alt="' + I + '" class="thumb" width="' + E + '" height="' + A + '">';
    var J = '<img src="' + F + '" alt="' + I + '" class="thumb" height="' + A + '" width="' + E + '">';
    var K = '<img src="' + F + '" alt="' + I + '" class="thumb" height="' + A + '" width="' + E + '"/>';
    ...
    if (element.innerHTML.toLowerCase() != D && element.innerHTML.toLowerCase() != B && element.innerHTML.toLowerCase() != J && element.innerHTML.toLowerCase() != K) {
        ...
        element.innerHTML = '<img src="' + H + '" alt="' + I + '" class="thumb" height="' + G + '" width="' + C + '">'
    }
}
