...
$smarty->assign('lang_manageboards', _gettext('Management'));
...
if (!$manage_class->ValidateSession(true)) {
	...
	'<ul>
	<li><a href="manage_page.php?action=announcement">'._gettext('Announcements').'</a></li>
	...
	if ($manage_class->CurrentUserIsAdministrator()) {
		...
		<li><a href="manage_page.php?action=menuedit">' . _gettext('Menu Editor') . '</a></li>
		...
		<li><a href="manage_page.php?action=rebuildhtml">' . _gettext('Rebuild HTML files') . '</a></li>' . "\n" .
		'</ul></div>';
	...
	'<ul>
	<li><a href="manage_page.php?action=manageboard">' . _gettext('Manage boards') . '</a></li>
	...
	$tpl_links .= section_html(_gettext('Hydrogen Modules'), 'siteadmin') .
	'<ul>
	<li><a href="manage_page.php?action=headadmanagement">' . _gettext('Header Ad') . '</a></li>
	<li><a href="manage_page.php?action=baseadmanagement">' . _gettext('Footer Ad') . '</a></li>
	<li><a href="manage_page.php?action=boardanalytics">' . _gettext('Board Analytics Script') . '</a></li>
	<li><a href="manage_page.php?action=menuanalytics">' . _gettext('Menu Analytics Script') . '</a></li>
	</ul></div>';
	...
	if ($manage_class->CurrentUserIsAdministrator() && $_SESSION['manageusername'] == 'root') {
	...
	$tpl_links .= '<br/><small>- Hydrogen '. KU_VERSION . ' -</small>';
}
