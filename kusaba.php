...
if (file_exists("install.php")) {
	die('You are seeing this message because either you haven\'t ran the install file yet, and can do so <a href="install.php">here</a>, or already have, and <b>must delete it</b>. Make sure to run <a href="install-mysql.php">install-mysql.php</a> first.');
}
if (!isset($_GET['info'])) {
